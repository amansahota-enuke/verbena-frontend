            ...
            <div className="">
              <div className="tele-health-content mb-8">
                <p className="dd text-lg caliber-regular mb-4 dark-gray-color">
                  ...
                  (“we”, “us”, or “our”) and how we handle personal information
                  that we collect through our website and platform
                ...
                <p className="dd text-lg caliber-regular mb-4 dark-gray-color">
                  ...
                  Portability and Accountability Act (“HIPAA”). When governed by
                  HIPAA, this information is called “Protected Health
                  Information” or “PHI.” Among other things, HIPAA regulates
                  what our health care partners may do with your PHI. As a HIPAA
                  “business associate” of these partners, Verbena must also
                ...
                <p className="dd text-lg caliber-regular mb-4 dark-gray-color">
                  ...
                  information about themselves (e.g., patients who use the
                  Service) as well as about each other (e.g., physicians who
                  provide information about their patients)
                </p>
                <ul className="list-disc pl-6">
                  ...
                  <li>
                    <p className="dd text-lg caliber-regular mb-4 dark-gray-color">
                      <b>Biographical and demographic information,</b> such as
                      date of birth, age, gender, marital status, and
                  ...
                  <li>
                    <p className="dd text-lg caliber-regular mb-4 dark-gray-color">
                      ...
                      when you contact us with questions, feedback, or
                      otherwise.
                    </p>
                  </li>
                  <li>
                    <p className="dd text-lg caliber-regular mb-4 dark-gray-color">
                      <b>Payment and transactional data</b> needed to complete
                      your orders on or through the Service (including name,
                      payment card information, bank account number, billing
                      information), and your purchase history.
                    </p>
                  </li>
                  <li>
                    <p className="dd text-lg caliber-regular mb-4 dark-gray-color">
                      <b>Marketing data,</b> such as your preferences for
                      receiving our marketing communications, and details about
                ...
                <p className="dd text-lg caliber-regular mb-4 dark-gray-color">
                  <b>Automatic data collection.</b> We and our service providers
                  may automatically log information about you, your computer or
                  mobile device, and your interaction over time with the
                  Services, our communications and other online services, such
                  as:
                </p>
                <ul className="list-disc pl-6">
                  <li>
                    <p className="dd text-lg caliber-regular mb-4 dark-gray-color">
                      ...
                      device carrier, radio/network information (e.g., WiFi,
                  ...
                  <li>
                    <p className="dd text-lg caliber-regular mb-4 dark-gray-color">
                      ...
                      GIFs, which are used to demonstrate that a webpage or
                ...
                <ul className="list-disc pl-6">
                  <li>
                    <p className="dd text-lg caliber-regular mb-4 dark-gray-color">
                      ...
                      facilitating your interaction with health care
                      professionals;
                    </p>
                  </li>
                  <li>
                  ...
                  <li>
                    <p className="dd text-lg caliber-regular mb-4 dark-gray-color">
                      Communicate with you about our Services, including by
                      sending announcements, updates, security alerts, and
                  ...
                  <li>
                    <p className="dd text-lg caliber-regular mb-4 dark-gray-color">
                      Provide support, and respond to your requests, questions
                      and feedback.
                    </p>
                  </li>
                </ul>
                <p className="dd text-lg caliber-regular mb-4 dark-gray-color">
                  ...
                  information we collect. We may use this anonymous data and
                  share it with third parties for our lawful business purposes,
                  including to analyze and improve the Services.
                </p>
                <p className="dd text-lg caliber-regular mb-4 dark-gray-color">
                  <b>Marketing and advertising.</b> We and our advertising
                  partners may use personal information for the our marketing
                ...
                <ul className="list-disc pl-6">
                  <li>
                    <p className="dd text-lg caliber-regular mb-4 dark-gray-color">
                      ...
                      permitted by law, including, but not limited to, notifying
                      you of special promotions, offers and events via postal
                      mail, email, telephone, text message, and other means. You
                      may opt out of our marketing communications as described
                  ...
                  <li>
                    <p className="dd text-lg caliber-regular mb-4 dark-gray-color">
                      ...
                      companies and social media companies, may display ads on
                      the Service and other online services. These companies may
                      use cookies and similar technologies to collect
                      information about your interaction (including the data
                      described in the “Automatic data collection” section
                      above) over time across the Service, our communications
                      and other online services, and use that information to
                      serve online ads that they think will interest you. This
                      is called interest-based advertising. We may also share
                      information about our users with these companies to
                      facilitate interest-based advertising to those or similar
                      users on other online platforms. You can learn more about
                      your choices for limiting interest-based advertising in
                ...
                <p className="dd text-lg caliber-regular mb-4 dark-gray-color">
                  ...
                  parties and as otherwise described in this Privacy Policy or
                ...
                <p className="dd text-lg caliber-regular mb-4 dark-gray-color">
                  <b>Service providers.</b> Companies and individuals that
                  provide services on our behalf or help us operate the Service
                  or our business (such as coordinating orders and prescription
                  fulfillment from pharmacy partners, hosting, information
                  technology, customer support, email delivery, and website
                  analytics services).
                </p>
                <p className="dd text-lg caliber-regular mb-4 dark-gray-color">
                  <b>Professional advisors.</b> Professional advisors, such as
                  lawyers, auditors, bankers and insurers, where necessary in
                ...
                <p className="dd text-lg caliber-regular mb-4 dark-gray-color">
                  ...
                  of, or equity interests in, Verbena or our affiliates
                  (including, in connection with a bankruptcy or similar
                  proceedings).
                </p>
                <h3>Your Choices</h3>
                <p className="dd text-lg caliber-regular mb-4 dark-gray-color">
                  <b>Access to information.</b> To keep your information
                  accurate, current, and complete, please contact us as
                  specified below. We will take reasonable steps to update or
                  correct information in our possession that you have previously
                  submitted via the Service. Please also feel free to contact us
                ...
                <p className="dd text-lg caliber-regular mb-4 dark-gray-color">
                  <b>Online tracking opt out.</b> There are a number of ways to
                  opt out of having your online activity and device data
                  collected through the Service, which we have summarized below:
                </p>
                <ul className="list-disc pl-6">
                  <li>
                    <p className="dd text-lg caliber-regular mb-4 dark-gray-color">
                      <b>Blocking cookies in your browser.</b> Most browsers let
                      you remove or reject cookies, including cookies used for
                  ...
                  <li>
                    <p className="dd text-lg caliber-regular mb-4 dark-gray-color">
                      ...
                      Your mobile device settings may provide functionality to
                  ...
                  <li>
                    <p className="dd text-lg caliber-regular mb-4 dark-gray-color">
                      <b>Using privacy plug-ins or browsers.</b> You can block
                      our websites from setting cookies used for interest-based
                      ads by using a browser with privacy features, like Brave,
                      or installing browser plugins like Privacy Badger,
                      Ghostery, or uBlock Origin, and configuring them to block
                      third party cookies/trackers. You can also opt out of
                      Google Analytics by downloading and installing the browser
                  ...
                  <li>
                    <p className="dd text-lg caliber-regular mb-4 dark-gray-color">
                      <b>Platform opt outs.</b> The following advertising
                      partners offer opt out features that let you opt out of
                      use of your information for interest-based advertising:
                    </p>
                  </li>
                  <li>
                    <p className="dd text-lg caliber-regular mb-4 dark-gray-color">
                      <b>Advertising industry opt out tools.</b> You can also
                      use these opt out options to limit use of your information
                ...
                <p className="dd text-lg caliber-regular mb-4 dark-gray-color">
                  ...
                  device or browser on which they are exercised, so you will
                  need to opt out on every browser and device that you use.
                </p>
                <p className="dd text-lg caliber-regular mb-4 dark-gray-color">
                  <b>Do Not Track.</b> Some Internet browsers may be configured
                  to send “Do Not Track” signals to the online services that you
                  visit. We currently do not respond to "Do Not Track" or
                ...
                <p className="dd text-lg caliber-regular mb-4 dark-gray-color">
                  ...
                  services operated by third parties. In addition, our content
                  may be integrated into web pages or other online services that
                  are not associated with us. These links and integrations are
                  not an endorsement of, or representation that we are
                  affiliated with, any third party. We do not control websites
                  or online services operated by third parties, and we are not
                ...
                <p className="dd text-lg caliber-regular mb-4 dark-gray-color">
                  ...
                  collect. However, no security measures are failsafe and we
                ...
                <p className="dd text-lg caliber-regular mb-4 dark-gray-color">
                  ...
                  requirements, to establish or defend legal claims, or for
                  fraud prevention purposes. To determine the appropriate
                  ...
                  of personal information, the purposes for which we process
                ...
                <p className="dd text-lg caliber-regular mb-4 dark-gray-color">
                  ...
                  transferred to other locations where privacy laws may not be
                  as protective as those in your state, province, or country.
                </p>
                <h3>Children</h3>
                <p className="dd text-lg caliber-regular mb-4 dark-gray-color">
                  If we have obtained consent from a parent or legal guardian,
                  Verbena may collect, use, and disclose the personal
                  information of a child under 13 as described throughout this
                  Privacy Policy. Parents or legal guardians may contact us to
                  ask if we have collected their child's personal information,
                  to review or correct that information, and to request that
                  Verbena stop collecting this information or have it deleted.
                  Such requests are subject to Verbena’s verifying to our
                  satisfaction that the requester is in fact the child's parent
                  or legal guardian.
                </p>
                ...
                <p className="dd text-lg caliber-regular mb-4 dark-gray-color">
                  ...
                  and posting it on the Service. If required by law we will also
                  provide notification of changes in another way that we believe
                  is reasonably likely to reach you, such as via email or
                  another manner through the Service. Any modifications to this
                  Privacy Policy will be effective upon our posting the modified
                  version (or as otherwise indicated at the time of posting). In
                  all cases, your use of the Service after the effective date of
                  any modified Privacy Policy indicates your acceptance of the
                  modified Privacy Policy.
                </p>
                <h3>How to Contact Us</h3>
                <p className="dd text-lg caliber-regular mb-4 dark-gray-color">
                  You can reach us by email at info@verbenacare.com or at the
                  following mailing address: 30 Mayflower Drive, Tenafly, NJ
                  07670
                </p>
              </div>
            </div>
