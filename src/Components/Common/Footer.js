                        ...
                        <div className="footer-detail-logo xl:mb-0 lg:mb-0 md-mb-4 sm:mb-4 mb-8">
                            ...
                            <div className="blog-footer-social-links">
                                <div className="grid xl:grid-cols-6 lg:grid-cols-4 md:grid-cols-6 sm:grid-cols-6 grid-cols-4 gap-2">
                                    ...
                                    <a href="https://twitter.com/verbena_care" target="_blank" className="social block cursor-pointer">
                                ...
                                <ul className="blog-footer-list">
                                    <li>
                                        <a href={`${process.env.REACT_APP_VERBENA_PATIENT}/home/appointment`}>
                                            <a className="font-18 mont-font mont-regular text-white cursor-pointer">
                                                Make Appointment
                                            </a>
                                        </a>
                                    </li>
                        ...
                        <div className="blog-footer-heading xl:mb-0 lg:mb-0 md-mb-4 sm:mb-4 mb-8">
                            ...
                            <div className="blog-footer-links">
                                <ul className="blog-footer-list">
                                    ...
                                    <li>
                                        <a href="mailto:info@verbenacare.com" className="font-18 mont-font mont-regular text-white cursor-pointer"
                                        >
                                            Contact
                                        </a>
                                    </li>
                                    <li>
                                        <Link className="font-18 mont-font mont-regular text-white cursor-pointer"
                                        to="/Why-Verbena"
                                        >
                                            Why Verbena?
                                        </Link>
                        ...
                        <div className="blog-footer-heading xl:mb-0 lg:mb-0 md-mb-4 sm:mb-4 mb-8 xl:mt-0 lg:mt-8">
                            ...
                            <div className="blog-footer-links">
                                <ul className="blog-footer-list">
                                    <li>
                                        <Link
                                            className="font-18 mont-font mont-regular text-white cursor-pointer"
                                            to="/about"
                                        >
                                            About Us
                                        </Link>
                    ...
                    <div className="blog-footer-bottom border-t-2 border-opacity-10">
                        <div className="flex items-center xl:flex-nowrap lg:flex-wrap md:flex-wrap sm:flex-wrap flex-wrap justify-between mt-4">
                            <div className="flex items-center xl:flex-nowrap lg:flex-wrap md:flex-wrap sm:flex-wrap flex-wrap">
                                ...
                                <div>
                                    <p className="font-18 mont-font mont-regular text-white opacity-50 font-16">
