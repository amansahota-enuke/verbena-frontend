            ...
            <div className="footer-detail-logo xl:mb-0 lg:mb-0 md-mb-4 sm:mb-4 mb-8">
              ...
              <div className="blog-footer-social-links">
                <div className="grid xl:grid-cols-6 lg:grid-cols-4 md:grid-cols-6 sm:grid-cols-6 grid-cols-4 gap-2">
                  <a
                    href="https://www.facebook.com/verbenacare/"
                    target="_blank"
                    className="social block cursor-pointer"
                  >
                    <i className="fab fa-facebook-f"></i>
                  </a>
                  <a
                    href="https://www.instagram.com/verbena_care/"
                    target="_blank"
                    className="social block cursor-pointer"
                  >
                  ...
                  <a
                    href="https://www.linkedin.com/company/herhealthnow/"
                    target="_blank"
                    className="social block cursor-pointer"
                  >
                  ...
                  <a
                    href="https://twitter.com/verbena_care"
                    target="_blank"
                    className="social block cursor-pointer"
                  >
            ...
            <div className="blog-footer-heading xl:mb-0 lg:mb-0 md-mb-4 sm:mb-4 mb-8">
              ...
              <div className="blog-footer-links">
                <ul className="blog-footer-list">
                  <li>
                    <a
                      href={`${process.env.REACT_APP_VERBENA_PATIENT}/home/appointment`}
                    >
