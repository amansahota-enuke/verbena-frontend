  ...
  const faq = [
    {
      ...
      answer:
        "Verbena is a comprehensive women’s digital and telehealth platform offering personalized care, consultations, specialty content and healthcare support in partnership with your personal physician. Consultations, care, services and solutions are provided by your chosen provider. Both of you will use the Verbena platform as a supplement to your in-person/in-office medical care.",
    },
    {
      question: "How does Verbena work?",
      answer:
        "Providers become part of the Verbena network and have access to all of the functions and features of the platform. Providers invite their patients to register to use Verbena as part of their digital and telehealth care options.",
    },
    {
      question: "How do I register for/enroll in Verbena?",
      answer:
        "You can enroll in Verbena by creating an account at verbenacare.com. If your provider is a current member/subscriber, you can continue care in person as well as with Verbena virtual and digital care options, depending upon the nature of your issue. If your provider is not a Verbena subscriber, we can help you select a participating provider.",
    },
    {
      question: "What kind of information do I need to provide?",
      answer:
        "In order to register, Verbena will collect basic health information (DOB, height, weight, basic health history) and insurance plan options. Verbena creates a custom patient profile or dashboard that tracks appointments and securely stores your current healthcare information.",
    },
    {
      question: "Can I update my information as needed?",
      answer:
        "Each time you log into Verbena, you will be able to update your personal and health information as needed.",
    },
    {
      question: "How do I know if my provider is a Verbena member?",
      answer:
        "The Verbena platform has a searchable directory (by name and location) of participating providers with professional medical information and a current bio.",
    },
    {
    ...
    {
      question:
        "Can I schedule a telehealth visit/appointment using the Verbena platform?",
      answer:
        "You can self schedule an appointment with your personal/selected provider using the calendar feature on the Verbena platform. In other words, you never have to call the office to schedule, cancel or change your appointment.",
    },
    {
      question: "What if I need to cancel or reschedule my appointment?",
      answer:
        "No problem. If you need to cancel or reschedule, just log in to your account and follow the prompts on the calendar feature. You will not need to call the office directly. Please note that you need to cancel your appointment 24 hours in advance in order to receive a refund. You can also reschedule your appointment and apply the telehealth fee. You will not receive a refund if you are a no show to your appointment.",
    },
    {
      question: "When are office hours?",
      answer:
        "Your provider has designated hours which will be featured on his/her profile and calendar page.",
    },
    {
      question: "How will I know if my appointment is confirmed?",
      answer:
        "Once you schedule your appointment, you will receive a confirmation email as well as a follow up reminder prior to your visit.",
    },
    {
    ...
    {
      question:
        "Will my doctor/provider have my personal health information or concerns available during the appointment?",
      answer:
        "Once you schedule an appointment, you will fill out a detailed “reason for visit” questionnaire. Your provider will thoroughly review this information prior to your appointment as well as other basic information or electronic health records as needed.",
    },
    {
      question:
        "What if I am still not feeling well after my telehealth appointment?",
      answer:
        "Sometimes, follow up is necessary.  Verbena has a direct to provider “chat feature” that will be available for 48 hours until your issue is resolved. If another tele-health visit or an in-person visit is needed let your provider know through the Verbena chat box. You can always call the office as well.",
    },
    {
      question: "Can I schedule an in-office visit using the Verbena platform?",
      answer:
        "The best way to schedule an in-office visit is by calling the office directly.",
    },
    {
      question:
    ...
    },
    {
      ...
      answer:
        "You can pay for your telehealth visit with a credit card directly on the Verbena site.    Your provider will submit any/all insurance claims directly on your behalf. Your credit card statement descriptor will be Verbena Telehealth Visit",
    },
    {
      question: "Which insurance plans are accepted?",
      answer:
        "Verbena appointments are subject to the insurance plans that your provider is currently enrolled in. There is a current list of participating providers on the ‘Create An Account’ page.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Verbena stores all of your personal and medical information securely and privately and does not share this information.",
    },
    {
      question: "What is Two Factor Authentication?",
      answer:
        "We offer an optional Two Factor Authentication (2FA) verification. 2FA supplements your password to provide your Verbena account with a second layer of security. You can enable 2FA in your Security setting in your Profile. We use Google Authenticator which generates a 2-step verification code to your phone. To enable Google Authenticator, you will have to download the app from the Apple Store or Google Apps.",
    },
    {
      question: "Is Verbena HIPPA compliant?",
      answer:
        "Yes, Verbena is a HIPPA compliant platform. Your personal/medical information is safe and secure.",
    },
    {
      question: "How can I get in touch with my provider through Verbena?",
      answer:
        "Enroll in Verbena and make an appointment with any Verbena provider. Through the platform you will be able to send and receive messages as it relates to your upcoming and follow up visit.",
    },
    {
      question:
        "What other resources or health information is available through Verbena?",
      answer:
        "Our Verbena ‘waiting room’ blog provides medically supervised articles and information related to women’s health and the specialties we address.",
    },
    {
      question: "What if I have a medical emergency?",
      answer:
        "If you have amedicall emergency call 911 or go to your nearest hospital/emergency room.",
    },
  ];
