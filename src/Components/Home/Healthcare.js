      ...
      <div className="flex xl:justify-end lg:justify-end md:justify-start sm:justify-start justify-start xl:flex-nowrap lg:flex-nowrap md:flex-wrap sm:flex-wrap flex-wrap">
        <div className="health-care-content xl:mb-0 lg:mb-0 md:mb-10 sm:mb-10 mb-10">
          ...
          <p className="font-20 mont-font mont-regular text-gray-dim mb-10">
            Created with her care in mind, Verbena celebrates the unique health
            needs throughout her lifetime—from menstruation to menopause (and
            everything in between). We provide a secure and direct line of
            communication to your personal doctor/provider anytime, anywhere.
          </p>
