        ...
        <div className="health-care-explore">
            ...
            <div className="flex justify-start">
                <div data-aos-duration="1000" data-aos="slide-right" className="health-explore-content">
                    <h3 className="font-72 hepta-bold question-title-color leading-none">Your Doctor.</h3>
                    <h3 className="font-72 hepta-bold question-title-color leading-none">Your Care.</h3>
                    <h3 className="font-72 hepta-bold question-title-color leading-none mb-10">Your Time.</h3>
